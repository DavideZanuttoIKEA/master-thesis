...
input_path = 'external_datasets/tsv_semEval2014/semEval2014.tsv'
output_path = 'external_datasets/tsv_semEval2014/semEval2014.json'
...
with open(input_path, 'r', newline='', encoding='utf-8') as file, open(output_path, 'w', encoding='utf-8') as jsonfile:
    ...
    if reader.fieldnames:
        ...
        if len(reader.fieldnames) < max([1,2]):
            raise ValueError("Not enough columns in the input file.")
        fieldnames = [reader.fieldnames[1], reader.fieldnames[2]]  # Adjust indices according to actual content
