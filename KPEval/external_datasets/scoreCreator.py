...
input_path = 'external_datasets/word_interchangeability/win353.csv'
output_path = 'external_datasets/word_interchangeability/scores.json'

# Function to map scores from 0-5 scale to 0-1 scale
def map_range(value, from_min=0, from_max=10, to_min=0, to_max=1):
