...
dataset_name = 'ext_sick'
embedding_method = 'sentence-transformers/all-mpnet-base-v2'
# Paths to the JSON files
json_path_f1 = f'eval_results/{dataset_name}/humanv2/semantic_matching_perdoc.jsonl'
json_path_scores = f'external_datasets/{dataset_name}/scores.json'
